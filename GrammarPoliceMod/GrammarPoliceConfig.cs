...
public sealed class GrammarPoliceConfig
{
    ...
    [ModKitConfigDisplay("10-2 Key Sequence")]
    public string KeySequence_10_2 { get; set; } = "";

    [ModKitConfigDisplay("10-3 Key Sequence")]
    public string KeySequence_10_3 { get; set; } = "";

    [ModKitConfigDisplay("10-4 Key Sequence")]
    public string KeySequence_10_4 { get; set; } = "";

    [ModKitConfigDisplay("10-5 Key Sequence")]
    public string KeySequence_10_5 { get; set; } = "";

    [ModKitConfigDisplay("10-6 Key Sequence")]
    public string KeySequence_10_6 { get; set; } = "";

    [ModKitConfigDisplay("10-7 Key Sequence")]
    public string KeySequence_10_7 { get; set; } = "";

    [ModKitConfigDisplay("10-8 Key Sequence")]
    public string KeySequence_10_8 { get; set; } = "";

    [ModKitConfigDisplay("10-9 Key Sequence")]
    public string KeySequence_10_9 { get; set; } = "";

    [ModKitConfigDisplay("10-10 Key Sequence")]
    public string KeySequence_10_10 { get; set; } = "";
    ...
    [ModKitConfigDisplay("Panic Dispatch Code")]
    public string PanicDispatchCode { get; set; } = "10-78";

    [ModKitConfigDisplay("Panic Dispatch Message")]
    public string PanicDispatchMessage { get; set; } = "Officer Needs Assistance — Panic Activated";

    [ModKitConfigDisplay("Panic Key Sequence (emulated on trigger)")]
